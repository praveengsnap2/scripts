...
public class ProcessImageServiceImpl implements ProcessImageService {
    ...
    public List<ImageAnalysis> invokeImageAnalysis(String imageFilePath, String category, String uuid, String retailer, String store, String userId, String projectTypeId) {
        LOGGER.info("---------------ProcessImageServiceImpl Starts invokeImageAnalysis----------------\n");
        LOGGER.info("---------------ProcessImageServiceImpl imageFilePath=" + imageFilePath + ", category=" + category + ", uuid=" + uuid + ", retailer=" + retailer + ", store=" + store + "userId= "+userId+"projectTypeId"+projectTypeId+"----------------\n");
        ...
        String result = shellUtil.executeCommand(imageFilePath, category, uuid, retailer, store, userId, projectTypeId);
        if (result.contains("{")) {
